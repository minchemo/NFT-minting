...
class Star {
    constructor() {
        ...
        _defineProperty(this, "reset", (start) => {
        ...
        _defineProperty(this, "update", (jumping) => {
            const x =
                Math.floor(
    ...
    constructor(options) {
        ...
        _defineProperty(this, "render", () => {
            ...
            ALPHA_STEP * 5)})`
                ...
                if (
                    Math.random() > 0.5 &&
                    this.STATE.starPool.filter((s) => s.STATE.active === false).length >
                    0 &&
                    !this.STATE.jumping
                ) {
                    this.STATE.starPool
                        .filter((s) => s.STATE.active === false)[0]
                        .activate()
                }
                ...
                for (const star of this.STATE.starPool) {
                    ...
                    if (
                        ...
                        context.drawImage(
                            ...
                            star.STATE.characteristics.scale,
                ...
                if (this.STATE.blanketOpacity >= 0) {
                    ...
                    context.fillStyle = `rgba(${r}, ${g}, ${b}, ${(this.STATE.blanketOpacity -=
            ALPHA_STEP)})`
                    context.fillRect(0, 0, innerWidth, innerHeight)
                }
            }
        ...
        _defineProperty(this, "generateStars", (amount) => {
            const result = []
