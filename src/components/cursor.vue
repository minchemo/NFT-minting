 ...
 */
    ...
    // play with these
    var settings = {
        colorChangeSpeedFactor: .2, // how fast does the color changes? Lower is slower, exponential
        trailLength: 50, // how long is the trail?
        diameter: 10, // how wide is the spray mark?
        fadeStart: .5 // where does the trail start fading out? percentage along itself
    }
