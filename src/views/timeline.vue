<template>
  <div class="container mx-auto min-h-screen flex flex-col pb-64 lg:pb-40">
    <PageTitle
      title="Plan 計画
"
    ...
    <div class="container mx-auto p-8 pt-0 pb-20 h-full scrollbar">
      <div
        class="flex mb-8 font-['Nunito'] gap-2 lg:gap-8 flex-wrap lg:flex-nowrap"
      >
      ...
      <div class="grid grid-rows-2 grid-cols-1 lg:grid-cols-4 gap-5">
        <div
          data-aos="zoom-in"
          class="text-3xl p-10 w-full flex items-center justify-center uppercase text-gray-500 font-black bg-white shadow-lg rounded-3xl relative hover:bg-sky-200 hover:translate-y-2 transition-all font-['Nunito']"
        >
        ...
        <template v-for="(item, i) in timelines">
          <div
            ...
            class="w-full flex flex-col bg-white p-8 pb-32 shadow-lg rounded-3xl relative overflow-hidden hover:bg-sky-200 hover:translate-y-2 font-normal transition-all font-['Nunito']"
          >
            <div
            ...
            <a
              ...
              :href="item.link"
              target="_blank"
              class="mt-2 bg-cyan-600 inline mr-auto text-white font-['nunito'] font-thin px-2 py-1 rounded-md text-sm"
              >LINK</a
            >
            <div class="absolute flex items-center left-8 bottom-8">
              ...
              <div class="font-black uppercase" v-html="item.title"></div>
            </div>
            <div
              class="absolute w-1/2 aspect-square bg-contain right-0 bottom-0 bg-no-repeat bg-bottom"
    ...
    const timelines = ref([
      {
        isFinished: true,
        isProcessing: false,
        title: "Collabs<br/>AmPm",
        description:
          "AmPm is come from Tokyo, Japan. Over 300,000 monthly listeners and a song with over 40 million plays on spotify.",
        img: new URL("../assets/timelines/ampm.png", import.meta.url).href,
        link: "https://twitter.com/Jidorinft/status/1515170483104546820",
      },
      {
        isFinished: true,
        isProcessing: false,
