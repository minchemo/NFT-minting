...
"
    ...
    <div class="container mx-auto p-8 h-full overflow-y-scroll scrollbar">
      ...
      <div class="grid grid-rows-2 grid-cols-4 gap-5">
        <div
          data-aos="zoom-in"
          class="text-3xl p-10 w-full flex items-center justify-center uppercase text-gray-500 font-black bg-white drop-shadow-xl rounded-3xl relative hover:bg-sky-200 hover:translate-y-2 transition-all font-['Nunito']"
        >
        ...
        <template v-for="(item, i) in timelines">
          <div
            ...
            class="w-full flex flex-col bg-white p-8 pb-32 drop-shadow-xl rounded-3xl relative overflow-hidden hover:bg-sky-200 hover:translate-y-2 font-normal transition-all font-['Nunito']"
          >
            <div
    ...
    const timelines = ref([
      {
        ...
        isProcessing: false,
        title: "Girls",
        description: `Jidori girls is our genesis collection, art and outfit ideas from people's selfies online, all hand-painted by Japanese amateur amateur painters.
      ...
      },
      {
        ...
        title: "Boys",
        description:
          "Jidori boys is second collection from us, allowing boys to find web3 selfies that look the most like you, Jidori-girl owners can claim 1:1 for free.",
      ...
      },
      {
        ...
        isProcessing: true,
        title: "App",
        description: `Ready to develop a match-dating APP list on ios and android store and all of world can found us on appstore. <br/><br/>Jidori's holder can use your NFT as a pass or unlock paid-only features (boost or superlike function like Tinder).`,
